...
public class VideoStd extends VideoLayout {
    ...
    public VideoStd(Context context) {
        super(context);
        this.videoPlayActivity = (VideoPlayActivity) context;
    }
    ...
    public void setUp(VideoSource VideoSource, int screen) {
        super.setUp(VideoSource, screen);
        titleTextView.setText(VideoSource.title);
        if (currentScreen == SCREEN_WINDOW_FULLSCREEN) {
            ...
            fullscreenButton.setImageResource(R.drawable.normal_screen);
    ...
    public void changeUrl(VideoSource VideoSource, long seekToInAdvance) {
        super.changeUrl(VideoSource, seekToInAdvance);
        titleTextView.setText(VideoSource.title);
        loadingProgressBar.setVisibility(VISIBLE);
        startButton.setVisibility(INVISIBLE);
    }
            ...
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if (!mChangePosition && !mChangeVolume) {
                        onEvent(UserActionInterfaceStd.ON_CLICK_BLANK);
                        onClickUiToggle();
                    }
                    break;
            }
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.thumb) {
            ...
            if (currentState == CURRENT_STATE_NORMAL) {
                ...
                startVideo();
                onEvent(UserActionInterfaceStd.ON_CLICK_START_THUMB);
            ...
            if (VideoMgr.getFirstFloor().currentScreen == VideoLayout.SCREEN_WINDOW_LIST) {
            ...
            onStatePreparing();
            onEvent(UserActionInterface.ON_CLICK_START_ERROR);
        }
    }
    ...
    public void showWifiDialog() {
        ...
        builder.setPositiveButton(getResources().getString(R.string.tips_not_wifi_confirm), new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
                onEvent(UserActionInterfaceStd.ON_CLICK_START_WIFIDIALOG);
                startVideo();
    ...
    public void setBatteryLevel() {
        ...
        if (percent < 15) {
            batteryLevel.setBackgroundResource(R.drawable.vp_battery_level_10);
        } else if (percent >= 15 && percent < 40) {
            batteryLevel.setBackgroundResource(R.drawable.vp_battery_level_30);
        } else if (percent >= 40 && percent < 60) {
            batteryLevel.setBackgroundResource(R.drawable.vp_battery_level_50);
        } else if (percent >= 60 && percent < 80) {
            batteryLevel.setBackgroundResource(R.drawable.vp_battery_level_70);
        } else if (percent >= 80 && percent < 95) {
            batteryLevel.setBackgroundResource(R.drawable.vp_battery_level_90);
        } else if (percent >= 95 && percent <= 100) {
            batteryLevel.setBackgroundResource(R.drawable.vp_battery_level_100);
        }
    }
    ...
    public void setAllControlsVisiblity(int topCon, int bottomCon, int startBtn, int loadingPro,
        ...
        if (lockcode==0){
            ...
            next.setVisibility(topCon);
            previous.setVisibility(topCon);
            orientation.setVisibility(topCon);
            ...
            unlockscreen.setVisibility(topCon);
        }
    }
    ...
    public void updateStartImage() {
        if (currentState == CURRENT_STATE_PLAYING) {
            ...
            startButton.getLayoutParams().height = 80;
            startButton.getLayoutParams().width = 80;
    ...
    public void showProgressDialog(float deltaX, String seekTime, long seekTimePosition, String totalTime, long totalTimeDuration) {
        ...
        if (deltaX > 0) {
            mDialogIcon.setBackgroundResource(R.drawable.forward);
        } else {
            mDialogIcon.setBackgroundResource(R.drawable.backward);
        }
