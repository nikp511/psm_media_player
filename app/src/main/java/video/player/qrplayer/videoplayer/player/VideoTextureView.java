...
public class VideoTextureView extends TextureView {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (parentWidth != 0 && parentHeight != 0 && videoWidth != 0 && videoHeight != 0) {
            if (VideoLayout.VIDEO_IMAGE_DISPLAY_TYPE == VideoLayout.VIDEO_IMAGE_DISPLAY_TYPE_FILL_PARENT) {
        ...
        if (parentWidth != 0 && parentHeight != 0 && videoWidth != 0 && videoHeight != 0) {
            if (VideoLayout.VIDEO_IMAGE_DISPLAY_TYPE == VideoLayout.VIDEO_IMAGE_DISPLAY_TYPE_ORIGINAL) {

                height = videoHeight;
                width = videoWidth;
            } else if (VideoLayout.VIDEO_IMAGE_DISPLAY_TYPE == VideoLayout.VIDEO_IMAGE_DISPLAY_TYPE_FILL_SCROP) {
                if (viewRotation == 90 || viewRotation == 270) {
                    int tempSize = parentWidth;
                    parentWidth = parentHeight;
                    parentHeight = tempSize;
