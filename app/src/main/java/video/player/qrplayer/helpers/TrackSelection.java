package video.player.qrplayer.helpers;
...
public class TrackSelection extends LinearLayout {
    ...
    public TrackSelection(Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
        ...
        defaultView.setTextColor(getResources().getColor(R.color.black));
    ...
    private void updateViews() {
        ...
        for (int groupIndex = 0; groupIndex < trackGroups.length; groupIndex++) {
            ...
            for (int trackIndex = 0; trackIndex < group.length; trackIndex++) {
                ...
                trackView.setTextColor(getResources().getColor(R.color.black));
    ...
    private void updateViewStates2() {
        ...
        for (int i = 0; i < trackViews.length; i++) {
            for (int j = 0; j < trackViews[i].length; j++) {
                ...
                trackViews[i][j].setChecked(b && override != null && override.groupIndex == i && override.containsTrack(j));
            }
        }
    }
