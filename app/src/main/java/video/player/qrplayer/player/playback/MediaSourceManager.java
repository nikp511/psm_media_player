...
import video.player.qrplayer.player.mediasource.FailedMediaSource;
import video.player.qrplayer.player.mediasource.LoadedMediaSource;
import video.player.qrplayer.player.mediasource.ManagedMediaSource;
import video.player.qrplayer.player.mediasource.ManagedMediaSourcePlaylist;
...
import video.player.qrplayer.player.playqueue.events.ReorderEvent;
import video.player.qrplayer.util.ServiceHelper;

import static video.player.qrplayer.player.mediasource.FailedMediaSource.MediaSourceResolutionException;
import static video.player.qrplayer.player.mediasource.FailedMediaSource.StreamInfoLoadException;
import static video.player.qrplayer.player.playqueue.PlayQueue.DEBUG;
...
public class MediaSourceManager {
    ...
    public MediaSourceManager(@NonNull final PlaybackListener listener,
        ...
        this(listener, playQueue, /*loadDebounceMillis=*/400L,
                TimeUnit.MILLISECONDS.convert(30, TimeUnit.SECONDS), TimeUnit.MILLISECONDS.convert(2, TimeUnit.SECONDS));
    }
