...
import video.player.qrplayer.Downloader;
import video.player.qrplayer.R;
import video.player.qrplayer.player.helper.LoadController;
import video.player.qrplayer.player.helper.MediaSessionManager;
import video.player.qrplayer.player.helper.PlayerDataSource;
import video.player.qrplayer.player.helper.PlayerHelper;
import video.player.qrplayer.player.mediasource.FailedMediaSource;
import video.player.qrplayer.player.playback.CustomTrackSelector;
import video.player.qrplayer.player.playback.MediaSourceManager;
import video.player.qrplayer.player.playback.PlaybackListener;
import video.player.qrplayer.player.playqueue.PlayQueue;
import video.player.qrplayer.player.playqueue.PlayQueueAdapter;
import video.player.qrplayer.player.playqueue.PlayQueueItem;
import video.player.qrplayer.player.resolver.MediaSourceTag;
import video.player.qrplayer.util.SerializedCache;
...
public abstract class BasePlayer implements
    ...
    public void onPlaybackUnblock(final MediaSource mediaSource) {
        ...
        Uri uri = Uri.parse(VideoPlayActivity.vidurl);
       /* MediaSource mediaSource1 = buildMediaSource(uri);
        simpleExoPlayer.prepare(mediaSource1);*/
